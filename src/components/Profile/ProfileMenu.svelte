...
>
  ...
  >
    ...
    <li class="hover:text-white">
      <a href="/profile/abc" on:click={profileMenuClose}>
        <PersonIcon className="inline-block mr-0.5 w-6 fill-white" />
        My profile
      </a>
    </li>
    <li class="hover:text-white">
      <a href="/account" on:click={profileMenuClose}>
        <SettingsIcon className="inline-block mr-0.5 w-6 fill-white" />
        My account
      </a>
    </li>
    <li class="hover:text-white" on:click={profileMenuClose}>
