<div
  id="login-form"
  class="flex flex-col justify-between items-center space-y-6 w-11/12 md:w-4/5 h-5/6 bg-zinc-800 z-50 fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 md:rounded-sm transition-opacity duration-700 dark-bg md:outline-2 md:outline-white/60 md:-outline-offset-[16px] md:outline-dashed"
...
>
  <div class="flex flex-col justify-center flex-1 mt-12 md:mt-0">
    <img
      ...
      alt="profile"
    />
    <h1 class="text-slate-300 text-2xl md:text-4xl text-center font-extrabold">
      Login to Forum
    </h1>
    <div class="mt-4 px-4 md:px-0">
      ...
      <label class="block text-slate-300 mt-2" for="password">Password</label>
      <input
        type="text"
        name="password"
        class="w-full h-8 px-2 rounded-sm mt-1"
